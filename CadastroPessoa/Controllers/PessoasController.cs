...
namespace CadastroPessoa.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CPF,Nome,Email,Identidade")] Pessoa pessoa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CPF,Nome,Email,Identidade")] Pessoa pessoa)
        {
            if (id != pessoa.Id)
            {
                return NotFound();
