...
namespace CadastroCRUD_Teste.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CPF,Nome,Email")] Pessoa pessoa)
        {
            if (ModelState.IsValid)
            {
                if (_context.Pessoa.Any(p => p.CPF == pessoa.CPF))
                {
                    ModelState.AddModelError("CPF", "CPF ja existe");
                    return View(pessoa);
                }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CPF,Nome,Email")] Pessoa pessoa)
        {
            if (id != pessoa.Id)
            {
                return NotFound();
